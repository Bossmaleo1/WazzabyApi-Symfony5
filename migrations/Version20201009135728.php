 ...
 */
final class Version20201009135728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category_problematic (id INT AUTO_INCREMENT NOT NULL, wording VARCHAR(255) NOT NULL, language VARCHAR(255) NOT NULL, icon VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, published DATETIME NOT NULL, wording VARCHAR(255) NOT NULL, anonymous INT NOT NULL, content LONGTEXT NOT NULL, published1 DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE private_message (id INT AUTO_INCREMENT NOT NULL, content VARCHAR(255) NOT NULL, published DATETIME NOT NULL, transmitter_anonymous INT NOT NULL, receiveranonymous INT NOT NULL, read_mention INT NOT NULL, read_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE problematic (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, wording VARCHAR(255) NOT NULL, icon VARCHAR(255) NOT NULL, language VARCHAR(255) NOT NULL, INDEX IDX_B366E46B12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
